                ...
                <div class="flex-row ml-md-auto">
                   ...
                   <span class="social">
                    ...
                    <?php } if(get_option('twitter')) { ?>
                        <a target="_blank" rel="noopener" href="<?php echo get_option('twitter'); ?>"><i class="fa fa-twitter"></i></a>
                    <?php } if(get_option('instagram')) {?>
                        <a target="_blank" rel="noopener" href="<?php echo get_option('instagram'); ?>"><i class="fa fa-instagram"></i></a>
                    <?php } if(get_option('linkedin')) {?>
                        <a target="_blank" rel="noopener" href="<?php echo get_option('linkedin'); ?>"><i class="fa fa-linkedin"></i></a>
                    <?php } ?>
                    </span>
                </div>
            </div>
