		...
		<div class="card-body pb-0">
			...
			<div class="collapse" id="workshop_<?php echo $randPostIDsForAccordion; ?>"  data-parent="#accordion">
				...
				<div class="d-flex mb-3 justify-content-between">
					<a class="btn btn-outline-success d-inline-flex" href="<?php echo esc_url(add_query_arg('start-date', $workshopStartDate, the_permalink()));//the_permalink();?>">Know more</a>
