...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script('isotope-js', get_template_directory_uri() . '/js/isotope.min.js', array('jquery'), '4.2.2', true);
		wp_enqueue_script('headroom-js', get_template_directory_uri() . '/js/headroom.min.js', array('jquery'), null, true);
		wp_enqueue_script( 'understrap-scripts', get_template_directory_uri() . '/js/theme.min.js', array('isotope-js','headroom-js'), $js_version, true );
		wp_localize_script('understrap-scripts','gfcustom_Ajax_function',array('ajaxurl' => admin_url('admin-ajax.php')));
