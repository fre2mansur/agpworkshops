	...
	<div class="row">
		<div class="col-lg-8">
			<div id="accordionData">
				<!-- Details -->
				<h3 data-toggle="collapse" data-target="#details" aria-expanded="true" aria-controls="details" class="collapse-before py-3 m-0">Details</h3>
				...
				<!-- Shedule	 -->
				<?php $title = '<h3 data-toggle="collapse" data-target="#shedule" aria-expanded="true" aria-controls="shedule" class="collapse-before py-3 m-0 collapsed">Schedule</h3>';?>
