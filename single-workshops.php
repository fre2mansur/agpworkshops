	...
	<div class="row">
		<div class="col-lg-8">
			<div id="accordionData">
				<!-- Details -->
				<h2 data-toggle="collapse" data-target="#details" aria-expanded="true" aria-controls="details" class="collapse-before py-3 m-0">Details</h2>
				...
				<!-- Shedule	 -->
				<?php $title = '<h2 data-toggle="collapse" data-target="#shedule" aria-expanded="true" aria-controls="shedule" class="collapse-before py-3 m-0 collapsed">Schedule</h2>';?>
				...
				<h2 data-toggle="collapse" data-target="#single-workshop-facilitators" aria-expanded="true" aria-controls="single-workshop-facilitators" class="collapse-before py-3 m-0 collapsed">Facilitators</h2>
				...
				<h2 data-toggle="collapse" data-target="#single-workshop-unit" aria-expanded="true" aria-controls="single-workshop-unit" class="collapse-before py-3 m-0 collapsed">Organizing Unit</h2>
